# -*- coding: utf-8 -*-
#
# panda-rootfs documentation build configuration file, created by
...
version = ".".join(release.split(b".")[:2])
...
latex_documents = [
  (master_doc, 'panda-rootfs.tex', u'panda-rootfs Documentation',
...
man_pages = [
    (master_doc, 'panda-rootfs', u'panda-rootfs Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'panda-rootfs', u'panda-rootfs Documentation',
   author, 'panda-rootfs', 'One line description of project.',
   'Miscellaneous'),
]
